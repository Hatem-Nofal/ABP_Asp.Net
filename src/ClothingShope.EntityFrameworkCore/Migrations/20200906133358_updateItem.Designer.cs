...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClothingShope.Items.Item", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ClothingShope.ItemsCategories.itemCategory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ClothingShope.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ClothingShope.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ClothingShope.Items.Item", b =>
                {
                    b.HasOne("ClothingShope.ItemsCategories.itemCategory", "itemCategory")
                        .WithMany("Items")
