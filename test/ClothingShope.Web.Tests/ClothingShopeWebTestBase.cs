...
{
    public abstract class ClothingShopeWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ClothingShopeWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ClothingShopeWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ClothingShopeDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ClothingShopeDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ClothingShopeDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ClothingShopeDbContext, Task<T>> func)
        {
            T result;
